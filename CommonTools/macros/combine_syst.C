...
void combine_syst(string path, string boson, string channel, string flag, int nLastBins)
{
  ...
  for (int bin = 0; bin < bkg_jetpho_misid->GetNbinsX() + 2; bin++) {
    ...
    bkg_irred->SetBinContent(bin, TMath::Sqrt(TMath::Power(bkg_irred_2016->GetBinContent(bin),2) + TMath::Power(bkg_irred_2017->GetBinContent(bin),2) + TMath::Power(bkg_irred_2018->GetBinContent(bin),2)));
    bkg_irred->SetBinError(bin, TMath::Sqrt(TMath::Power(TMath::Power(bkg_irred_2016->GetBinContent(bin),2) + TMath::Power(bkg_irred_2017->GetBinContent(bin),2) + TMath::Power(bkg_irred_2018->GetBinContent(bin),2), -1) * (TMath::Power(bkg_irred_2016->GetBinContent(bin) * bkg_irred_2016->GetBinError(bin), 2) + TMath::Power(bkg_irred_2017->GetBinContent(bin) * bkg_irred_2017->GetBinError(bin), 2) + TMath::Power(bkg_irred_2018->GetBinContent(bin) * bkg_irred_2018->GetBinError(bin), 2))));

    if (boson == "WGG") {
      bkg_egmisid->SetBinContent(bin, TMath::Sqrt(TMath::Power(bkg_egmisid_2016->GetBinContent(bin),2) + TMath::Power(bkg_egmisid_2017->GetBinContent(bin),2) + TMath::Power(bkg_egmisid_2018->GetBinContent(bin),2)));
      bkg_egmisid->SetBinError(bin, TMath::Sqrt(TMath::Power(TMath::Power(bkg_egmisid_2016->GetBinContent(bin),2) + TMath::Power(bkg_egmisid_2017->GetBinContent(bin),2) + TMath::Power(bkg_egmisid_2018->GetBinContent(bin),2), -1) * (TMath::Power(bkg_egmisid_2016->GetBinContent(bin) * bkg_egmisid_2016->GetBinError(bin), 2) + TMath::Power(bkg_egmisid_2017->GetBinContent(bin) * bkg_egmisid_2017->GetBinError(bin), 2) + TMath::Power(bkg_egmisid_2018->GetBinContent(bin) * bkg_egmisid_2018->GetBinError(bin), 2))));
    }
  }
