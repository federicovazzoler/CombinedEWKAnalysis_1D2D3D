...
for YEAR in ${YEARS}; do
  ...
  for CHANNEL in $CHANNELS; do
    ...
    for FLAG in $FLAGS; do
      ...
      elif [[ "$FLAG" == "jet_misid_syst" || "$FLAG" == "xsec_syst_wg" || "$FLAG" == "xsec_syst_zg" || "$FLAG" == "xsec_syst_other" ]]; then
...
FLAGS=$(echo $FLAGS | sed -e "s; jet_misid_syst; jet_misid_syst_up jet_misid_syst_down;" | sed -e "s; xsec_syst_wg; xsec_syst_wg_up xsec_syst_wg_down;" | sed -e "s; xsec_syst_zg; xsec_syst_zg_up xsec_syst_zg_down;" | sed -e "s; xsec_syst_other; xsec_syst_other_up xsec_syst_other_down;")
